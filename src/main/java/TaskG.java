...
public class TaskG {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(job, new Path("C:\\Users\\ashto\\IdeaProjects\\CS4433-Project-1\\access_logs.csv"));
        FileOutputFormat.setOutputPath(job, new Path("C:\\Users\\ashto\\IdeaProjects\\CS4433-Project-1\\output+taskg"));
